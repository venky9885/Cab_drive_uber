...
export const notificationHandlerModule = async function (snapshot: QueryDocumentSnapshot, context: EventContext) {      
      ...
      const androidNotificationToken =  await ownerData.data()["androidNotificationToken"];
...
export async function sendFCM(androidNotificationToken: string, payload: admin.messaging.DataMessagePayload) {
